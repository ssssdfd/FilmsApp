...
import com.example.mymovieapp.databinding.FragmentPopularFilmsBinding
...
class PopularFilmsFragment : Fragment(), FilmPagerAdapter.ItemClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        binding.myPopularRecyclerView.layoutManager = LinearLayoutManager(requireContext())
        binding.myPopularRecyclerView.adapter = this.adapter

        loadStateListener(adapter, binding.myPopularProgressBar, binding.retryBtn)
    ...
    private fun getData(){
        ...
        viewLifecycleOwner.lifecycleScope.launch(Dispatchers.IO) {
            viewModel.getFilmsList("popular").collectLatest { data ->
